	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/STAR_CODER7")
...
*2.
━━━━━
To purchase from here @STAR_CODER7</b>
...
def respond_to_vbv(message):
	def my_function():
		...
		try:
			...
			msg=f'''<b>𓆩𝗞𝗲𝘆 𝗥𝗲𝗱𝗲𝗲𝗺𝗲𝗱 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆𓆪! ✅  𝐃ev : 『@STAR_CODER7』  »»{timer}✅»{typ}</b>'''
